...
10 Tracks Looper for Raspberry Pi with Mute, Solo, Undo and Clear functions and FluidSynth (a soundfont sample player) running at the same time, connected into looper and controlled with the footswitches.
